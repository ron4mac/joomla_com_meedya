'use strict';Meedya.AArrange=function(m){let d=null,e=null,f=!1,g=!1,h=null,k,p=(a,b,c)=>{a={task:"manage.adjustAlbPaid",aid:a,paid:b};a[Joomla.getOptions("csrf.token","")]=1;m.postAction(null,a,n=>c(n))},l=a=>{if(a.target==d)return!1;a=a.dataTransfer.types;for(let b=0;b<a.length;++b)if("meeid"===a[b])return!0;return!1},q=a=>{d=a.target;setTimeout(()=>{d.style.opacity="0.2"},0);a.dataTransfer.effectAllowed="copyMove";a.dataTransfer.setData("meeid",d.dataset.id);a.dataTransfer.dropEffect="move"},r=
...
q,!0);Meedya._ae(c,"dragenter",t);Meedya._ae(c,"dragover",r);Meedya._ae(c,"dragleave",u);Meedya._ae(c,"drop",v);Meedya._ae(c,"dragend",w);Meedya._ae(c,"touchmove",y)})},selalb:()=>e?e.dataset.aid:0,iSelect:(a,b=this)=>{Meedya._pd(a);e&&e.classList.remove("slctd");b==e?e=null:(e=b,e.classList.add("slctd"))}}}(Meedya);