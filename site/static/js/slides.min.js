...
case 9:case 13:e.doMnu(6)}}function U(a){var b=a.changedTouches[0],c=N-b.clientX;b=O-b.clientY;a.preventDefault();400<a.timeStamp-P||(Math.abs(c)>Math.abs(b)?150<Math.abs(c)&&(0<c?e.doMnu(4):e.doMnu(2)):150<Math.abs(b)&&e.doMnu(3))}function V(a){var b=a.changedTouches[0];N=b.clientX;O=b.clientY;P=a.timeStamp;a.preventDefault()}function W(){J&&clearTimeout(J);J=setTimeout(function(){D=!0;trzn.resz();k(0);D=!1},200)}function Q(){$id("seconds").innerHTML=Math.round(q/1E3)}function X(){this.eMsg='<p class="errMsg">'+
imgerror+this.src+"</p>";this.src="components/com_meedya/static/css/broken.png"}function Y(a){p.innerHTML+='<p class="errMsg">'+viderror+this.src+"</p>";u&&(m=setTimeout(function(){k(1)},q))}var e={autoPlay:!0,slideDur:7E3,trnType:"d",repeat:!1},l=0,t=5,h=2,r=0,f=[],B,A,q=7E3,m=null,u=!1,z=null,C=null,p=null,E=null,H,J=null,D=!1,N,O,P,Z={preS:function(a){v(a,null)},pull:function(a,b){a.className="islide img_hide"},getI:function(a,b,c){n(a,b,c)},resz:function(){F()}},aa={preS:function(a){v(a,null)},
pull:function(a,b){a.className="islide img_off"},getI:function(a,b,c){n(a,b,c)},resz:function(){F()}},ba={preS:function(a,b){b?v(a,function(){a.style.left=-(a.width+2)+"px"}):v(a,function(){a.style.left=window.innerWidth+2+"px"})},pull:function(a,b){a.style.left=b?-(a.width+2)+"px":window.innerWidth+2+"px"},getI:function(a,b,c){a.className="islide";n(a,b,c)},resz:function(){var a=t-h,b;F();for(b=0;b<a;b++){var c=f[b+h];c.style.left=window.innerWidth+2+"px"}for(b=0;b<h;b++)c=f[b],c.style.left=-(c.width+
2)+"px"}};e.doMnu=function(a){switch(a){case 0:popdwin?window.close():window.history.back();break;case 1:w();I(0);k(0);break;case 2:w();k(-1);break;case 3:m?w():L();break;case 4:w();k(1);break;case 5:w();I(l-1);k(0);break;case 6:a=$id("cb_full"),z.isFullScreen()?(z.cancelFullScreen(),a.style.backgroundPosition="-126px 0"):z.supportsFullScreen&&(z.requestFullScreen(document.body),a.style.backgroundPosition="-144px 0")}};e.sdur=function(a){a?q+=1E3:3E3<q&&(q-=1E3);Q()};e.init=function(a){var b,c=$id("screen");
trzn=Z;A="islide img_show";B="islide img_hide";switch(this.trnType){case "d":trzn=aa;A="islide img_on";B="islide img_off";break;case "s":trzn=ba,A="islide img_slin",B="islide"}l=imagelist.length;l<t&&(t=l);for(b=0;b<t;b++){var g=document.createElement("IMG");g.onerror=X;g.style.left=window.innerWidth+2+"px";g.className=B;f.push(g);c.appendChild(g)}_vElm=document.createElement("VIDEO");_vElm.style.display="none";_vElm.onerror=Y;_vElm.className="medsld";_vElm.id="medsld";_vElm.controls=!0;_vElm.onended=
function(){u&&k(1)};_vElm.oncanplay=function(){this.style.display="block";this.play()};c.appendChild(_vElm);h=Math.floor(t/2);c.addEventListener("touchstart",V,!1);c.addEventListener("touchmove",function(x){x.preventDefault()},!1);c.addEventListener("touchend",U,!1);z=a;C=$id("slidnum");p=$id("ptext");E=$id("cb_paus");H=$id("loading");q=this.slideDur;Q();I(0);this.autoPlay?L():k(0);window.onresize=W};document.addEventListener("keypress",function(a){switch(a.charCode){case 32:case 91:case 93:case 13:M(a,
a.charCode)}},!1);document.addEventListener("keydown",function(a){switch(a.keyCode){case 37:case 39:case 27:case 9:M(a,a.keyCode)}},!1);return e}();window.onload=function(){ssCtl.init(fullScreenApi)};