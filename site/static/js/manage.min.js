...
break;case "icon-upload":a._pd(b);e.location=h.aURL+"manage.doUpload&aid="+c.parentElement.dataset.aid;break;case "icon-delete":a._pd(b);a.alb2delete=c.parentElement.dataset.aid;n("delact");break;case "album":a.AArrange.iSelect(b,c);break;case "icon-edit aclone":a._pd(b),q("manage.getAlbum",{aid:c.parentElement.dataset.aid},d=>{a._id("clnaid").value=d.aid;a._id("clalbnamed").value=d.title;a._id("cln_palbumed").value=d.paid;a._id("clalbdesced").innerHTML=d.desc;n("clnalbdlged")},!0)}};a.saveAlbum=
...
a._id("h5u_palbum").value;document.adminForm.nualbdesc.value=a._id("albdesc").value;document.adminForm.task.value="manage.movItemsToAlbum";document.adminForm.submit()};a.ae_createAlbum=b=>{b.disabled=!0;b=a._id("nualbnam");let c=a._id("h5u_palbum"),d=a._id("albdesc");b={albnam:b.value.trim(),paralb:c?c.value:0,albdesc:d.value};b[k]=1;q("manage.newAlbum",b,g=>{g?alert(g):e.location.reload(!0)})};a.ae_cloneAlbum=b=>{b.disabled=!0;b=a._id("clalbnam");let c=a._id("cln_palbum"),d=a._id("clalbdesc"),g=
a._id("oaid");b={albnam:b.value.trim(),paralb:c?c.value:0,albdesc:d.value,oaid:g.value};b[k]=1;q("manage.clnAlbum",b,m=>{m?alert(m):e.location.reload(!0)})};a.ae_cloneAlbSave=b=>{b.disabled=!0;b=a._id("clalbnamed");let c=a._id("cln_palbumed"),d=a._id("clalbdesced"),g=a._id("clnaid");b={albnam:b.value.trim(),paralb:c?c.value:0,albdesc:d.value,aid:g.value};b[k]=1;q("manage.clnAlbSave",b,m=>{m?alert(m):e.location.reload(!0)})};let r=null;a.moveItem=(b,c)=>{a._pd(b,!0);b=c.parentElement;if(r){r.classList.remove("moving");
...
160,b.height=u,d.drawImage(g,y,0,t,v,0,0,160,u),d.drawImage(m,0,0,z,A,3,3,z,A),b=b.toDataURL("image/jpeg",.8),c={vid:c,imgBase64:b},c[k]=1,q("manage.setVideoThumb",c,B=>{a.thmelmsrc.src=B;a.Zoom.close()})):alert("Did not locate the video.")};let w=!1;a.dirtyThumbs=b=>{(w=b)&&a.albdirt()}})(window.Meedya=window.Meedya||{},Joomla.getOptions("Meedya"),window);
(function(a){let h,e,k=f=>{f&&a._pd(f);document.body.removeChild(h)},p=f=>{switch("keydown"==f.type?f.keyCode:f.charCode){case 32:case 13:case 27:k(f)}};a.Zoom={open:(f,l)=>{l&&(a.thmelmsrc=l.parentElement.previousElementSibling.firstElementChild);e=document.createElement("div");a.postAction("manage.getZoomItem",{iid:f},n=>{e.innerHTML=n});e.className="zoom-area";e.tabIndex="-1";h=document.createElement("div");h.className="zoom-back";h.appendChild(e);document.body.appendChild(h);a._ae(e,"keypress",
p);a._ae(e,"keydown",p);e.focus();a._ae(h,"click",k)},close:k}})(Meedya);
(function(a){let h,e,k=f=>{f&&a._pd(f);document.body.removeChild(h)},p=f=>{switch("keydown"==f.type?f.keyCode:f.charCode){case 32:case 13:case 27:k(f)}};a.itmInfo={open:(f,l)=>{l&&(a.thmelmsrc=l.parentElement.previousElementSibling.firstElementChild);e=document.createElement("div");a.postAction("manage.getItemInfo",{iid:f},n=>{e.innerHTML=n});e.className="info-area";e.tabIndex="-1";h=document.createElement("div");h.className="zoom-back";h.appendChild(e);document.body.appendChild(h);a._ae(e,"keypress",
p);a._ae(e,"keydown",p);e.focus();a._ae(h,"click",k)},close:k}})(Meedya);