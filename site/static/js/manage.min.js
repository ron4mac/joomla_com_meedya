...
(function(a){let h,f,l=g=>{g&&a._pd(g);document.body.removeChild(h)},q=g=>{switch("keydown"==g.type?g.keyCode:g.charCode){case 32:case 13:case 27:l(g)}};a.Zoom={open:(g,k)=>{k&&(a.thmelmsrc=k.parentElement.previousElementSibling.firstElementChild);f=document.createElement("div");a.postAction("manage.getZoomItem",{iid:g},r=>{f.innerHTML=r});f.className="zoom-area";f.tabIndex="-1";h=document.createElement("div");h.className="zoom-back";h.appendChild(f);document.body.appendChild(h);a._ae(f,"keypress",
q);a._ae(f,"keydown",q);f.focus();a._ae(h,"click",l)},close:l}})(Meedya);