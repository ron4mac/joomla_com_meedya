...
//	$('INPUT.minicolors').minicolors({change: function(aa,bb,cc){console.log(aa,bb,cc)}});
////	$.minicolors.defaultSettings.change = function(aa){console.log(aa);console.log(this)};
