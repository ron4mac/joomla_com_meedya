...
/**
 * Meedya Component MeedyaItem Model
 *
 * @package		Joomla.Site
 * @subpackage	com_meedya
 * @since		1.5
 */
class MeedyaModelCategory extends JModelList
{
	/**
	 * Category items data
	 *
	...
	/**
	 * The list of other meedyaitem categories.
	 *
	 * @access	protected
	 * @var		array
	 */
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$orderCol	= $input->getCmd('filter_order', 'ordering');
		if (!in_array($orderCol, $this->filter_fields)) {
			$orderCol = 'ordering';
		}
		$this->setState('list.ordering', $orderCol);

		$listOrder	=  $input->getCmd('filter_order_Dir', 'ASC');
		...
		$user = JFactory::getUser();
		if ((!$user->authorise('core.edit.state', 'com_meedya')) &&  (!$user->authorise('core.edit', 'com_meedya'))){
	...
	public function getCategory()
	{
		if(!is_object($this->_item))
		{
			...
			$categories = JCategories::getInstance('Meedya', $options);
