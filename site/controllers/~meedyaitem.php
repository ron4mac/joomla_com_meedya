<?php
/**
 * @version		$Id: meedyaitem.php 20899 2011-03-07 20:56:09Z ian $
 ...
 * @since		1.5
 */
no class MeedyaControllerMeedyaItem extends JControllerForm
{
	/**
	 * @since	1.6
	 */
	...
	protected function postSaveHook(JModel &$model, $validData = array())
	{
		...
		if ($task == 'save') {
			$this->setRedirect(JRoute::_('index.php?option=com_meedya&view=category&id='.$validData['catid'], false));
		}
	}
	...
	public function go()
	{
		...
		$modelLink	= $this->getModel('MeedyaItem', '', array('ignore_request' => true));
		...
		if (empty($link)) {
			return JError::raiseWarning(404, JText::_('COM_MEEDYA_ERROR_MEEDYAITEM_NOT_FOUND'));
		}
		...
		$modelCat = $this->getModel('Category', 'MeedyaModel', array('ignore_request' => true));
		...
		if ($link->url) {
			...
			return JError::raiseWarning(404, JText::_('COM_MEEDYA_ERROR_MEEDYAITEM_URL_INVALID'));
		}
	}
}
