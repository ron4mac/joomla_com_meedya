 ...
 * @since		1.5
 */
class MeedyaModelMeedyaItem extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 * @since	1.6
	 */
	protected $text_prefix = 'COM_MEEDYA';
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'MeedyaItem', $prefix = 'MeedyaTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		if ($this->getState('meedyaitem.id')) {
