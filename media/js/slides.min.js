...
ha=a=>{a=a.target;a.eMsg='<p class="errMsg">'+imgerror+a.src+"</p>";a.src=_imgP+"broken.png"},ia=a=>{u.innerHTML+='<p class="errMsg">'+viderror+a.target.currentSrc+"</p>";x&&(p=setTimeout(()=>{m(1)},t))};c.sdur=a=>{a?t+=1E3:3E3<t&&(t-=1E3);q("seconds").innerHTML=Math.round(t/1E3)};c.init=a=>{var b,d=q("screen");n=W;H="islide img_show";G="islide img_hide";switch(c.trnType){case "d":n=X;H="islide img_on";G="islide img_off";break;case "s":n=Y,H="islide img_slin",G="islide"}k=imagelist.length;k<v&&(v=
k);for(b=0;b<v;b++){var e=document.createElement("DIV");e.style.left=r+"px";e.className=G;var C=document.createElement("IMG");C.onerror=ha;e.appendChild(C);f.push(e);d.appendChild(e)}h=document.createElement("VIDEO");h.style.display="none";h.onerror=ia;h.className="medsld";h.id="medsld";h.controls=!0;h.onended=fa;h.playsinline=!0;h.onloadedmetadata=l=>{l=l.target;l.style.display="block";l.play()};d.appendChild(h);g=Math.floor(v/2);y(d,"touchstart",da);y(d,"touchmove",l=>l.preventDefault());y(d,"touchend",
ca);A=a;I=q("slidnum");u=q("ptext");J=q("cb_paus");K=q("loading");t=c.slideDur;q("seconds").innerHTML=Math.round(t/1E3);P(0);c.autoPlay?U():m(0);y(window,"resize",ea)};y(document,"keypress",a=>{switch(a.charCode){case 32:case 91:case 93:case 13:V(a,a.charCode)}});y(document,"keydown",a=>{switch(a.keyCode){case 37:case 39:case 27:case 9:V(a,a.keyCode)}});return c}();window.onload=function(){ssCtl.init(fullScreenApi)};